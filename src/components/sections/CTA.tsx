...
const CTA = () => {
  return (
    <section className="py-24 container mx-auto px-6">
      <div className="bg-primary rounded-[2rem] md:rounded-[3rem] p-10 md:p-20 text-center text-black relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <button className="bg-black text-white font-bold px-10 py-4 rounded-xl text-lg hover:scale-105 transition-transform">
                Start Now →
              </button>
            </a>
          </div>
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-black/5 rounded-full"></div>
      </div>
    </section>
  );
};
